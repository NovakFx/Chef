  ...
  return (
    <div>
      ...
      <nav className='py-3 px-7  w-full   '>
       ...
       <ul className='flex  gap-[10%] pb-2  sm:gap-[10]  md:gap-[30] md:mx-20 xl:gap-[18%] xl:mx-3 2xl:mx-56  2xl:'>
        ...
        <div className='flex  sm:hidden xl:flex gap-20 2xl:gap-2  '>
         <input type="search" name="Search" id="" placeholder='Search' className=' w-full  border-2 border-gray-400 rounded-3xl text-sm px-3 border-opacity-25 text-gray-500 2xl:mt-1 duration-200 outline-none sm:hidden xl:block 2xl:w-80 2xl:h-10 ' />
         <div className='bg-customGreen py-3 px-3 text-white text-2xl rounded-full sm:hidden xl:block xl:w-[15%]  2xl:w-[48px] 2xl:h-[48px]'> <CiSearch /> </div>
        </div>

        <div className='py-2 flex gap-20  items-center text-xl sm:text-sm sm:gap-5  md:text-xl md:px-4 2xl:ml'><button className=' '>Your Account</button>
